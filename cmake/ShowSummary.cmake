...
message(STATUS " USBTINGO_INSTALL                         : " ${USBTINGO_INSTALL})
if(USBTINGO_INSTALL)
message(STATUS " USBTINGO_INSTALL_DEV_COMPONENTS          : " ${USBTINGO_INSTALL_DEV_COMPONENTS})
endif()
...
message(STATUS " USBTINGO_BUILD_UTILS                     : " ${USBTINGO_BUILD_UTILS})
if(WIN32)
	message(STATUS " USBTINGO_USE_WINAPI                      : " ${USBTINGO_USE_WINAPI})
endif()
message(STATUS "")
message(STATUS " ____________________________ TESTS ____________________________")
message(STATUS " USBTINGO_BUILD_TESTS                     : " ${USBTINGO_BUILD_TESTS})
message(STATUS " USBTINGO_ENABLE_INTERACTIVE_TESTS        : " ${USBTINGO_ENABLE_INTERACTIVE_TESTS})
message(STATUS " USBTINGO_ENABLE_TESTS_WITH_OTHER_DEVICES : " ${USBTINGO_ENABLE_TESTS_WITH_OTHER_DEVICES})
message(STATUS "")
...
elseif(NOT USBTINGO_INSTALL)
	message(STATUS " Package generator               : Installation disabled (USBTINGO_INSTAL). No package generation.")
else()
